...
export default function CresimeList() {
  ...
  const handleStampaElenco = () => {
    const url = pdfApi.elencoView('cresime', { search, anno })
              ...
              <tbody>
                {data.map(c => (
                  <tr key={c.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-gray-600">{formatDate(c.data_cresima)}</td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2 justify-end">
                        <button
                          onClick={() => navigate(`/cresime/${c.id}/certificato`)}
