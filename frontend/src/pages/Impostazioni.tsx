...
import { Save, Upload, Trash2, Building2, FileText, ChevronRight, HardDrive } from 'lucide-react'
  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <Link
          to="/impostazioni/modelli"
          className="group flex items-center gap-4 p-4 bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-100 rounded-xl hover:from-indigo-100 hover:to-violet-100 transition-colors"
        >
          <div className="p-2.5 bg-white rounded-lg shadow-sm">
            <FileText className="text-indigo-600" size={20} />
          </div>
          <div className="flex-1">
            <p className="font-semibold text-gray-800">Modelli certificati</p>
            <p className="text-xs text-gray-600 mt-0.5">
              Personalizza testo e segnaposti dei PDF.
            </p>
          </div>
        ...
        <Link
          to="/impostazioni/backup"
          className="group flex items-center gap-4 p-4 bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 rounded-xl hover:from-emerald-100 hover:to-teal-100 transition-colors"
        >
          <div className="p-2.5 bg-white rounded-lg shadow-sm">
            <HardDrive className="text-emerald-600" size={20} />
          </div>
          <div className="flex-1">
            <p className="font-semibold text-gray-800">Backup ed esportazioni</p>
            <p className="text-xs text-gray-600 mt-0.5">
              Scarica/ripristina il DB, esporta in CSV o ZIP.
            </p>
          </div>
          <ChevronRight className="text-emerald-400 group-hover:translate-x-1 transition-transform" size={18} />
        </Link>
      </div>
