...
export default function BattesimiList() {
  ...
  const handleStampaElenco = () => {
    const url = pdfApi.elencoView('battesimi', { search, anno })
              ...
              <tbody>
                {data.map(b => (
                  <tr key={b.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-gray-600">{formatDate(b.data_battesimo)}</td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2 justify-end">
                        <button
                          onClick={() => navigate(`/battesimi/${b.id}/certificato`)}
