...
def main():
    # Modalità desktop: nessun login richiesto in locale (l'app gira sul PC della
    # parrocchia). Per l'accesso remoto/web avviare invece uvicorn senza questa var.
    os.environ.setdefault("RECHURCH_DESKTOP", "1")
